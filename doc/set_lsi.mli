...
(** Ensembles sur des elements ordonnes.

   Ce module implante la structure de donnee d'ensemble sur des elements
   ordonnes.
   Les ensemble sont gere par une implantation d'arbre bicolores,
...
(** Module de type TypeOrdonne pouvant servir de paramettre au 
    ...
    Ce module implante les entiers (int). *)

module CoupleEntierEntier : TypeOrdonne
(** Module de type TypeOrdonne pouvant servir de paramettre au 
    foncteur Make pour obtenir un ensemble de couple d'entiers.
    Ce module implante les couples d'entiers (int * int). *)

module CoupleEntierChar : TypeOrdonne
(** Module de type TypeOrdonne pouvant servir de paramettre au 
    foncteur Make pour obtenir un ensemble de couple dont
    la premiere composante est un entier et la seconde un caractere.
    Ce module implante ainsi les couples (int * char). *)
...
sig
  ...
  val ens_vide : ensemble
    (** Ensemble vide de type : ensemble *)
